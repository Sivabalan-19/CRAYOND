  ...
  return (
    <div className="sibar">
      <div className="iconbox">
        ...
        >
          <Iconbox name="Sales" icon={<MdDashboard />} />
        </div>
        <div className="iconboxcon">
          <Iconbox name="Order" icon={<MdDashboard />} />
        </div>
        <div className="iconboxcon">
          <Iconbox name="Customer" icon={<MdDashboard />} />
        </div>
        <div className="iconboxcon">
          <Iconbox name="Inventory" icon={<MdDashboard />} />
        </div>
        <div className="iconboxcon">
          <Iconbox name="Alert" icon={<MdDashboard />} />
        </div>
      </div>
    </div>
  );
